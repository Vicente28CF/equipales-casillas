...
function getProductDetailURL(productIndex, callback) {
    ...
    xhr.open('GET', '/get_promocion_detail_url', true);
    xhr.onload = function () {
                ...
                <div class="product-card">
                    ...
                    <div class="product-card-info">
                        <div class="product-btn">
                            ...
                            <a href="/promocion-detail?id=${e.id}" class="btn-flat btn-hover btn-shop-now product-link" data-index="${startIndex + index}" data-product-id="${e.id}">Ver Producto</a>
